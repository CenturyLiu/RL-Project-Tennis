...
class ActorParamNoise(Actor):
    def __init__(self, local_obs_dim, action_size, seed = 2, fc1_units = 128, fc2_units = 256, stddev = 0.1):
    ...
    def reset_noise_parameters(self):
        self.fc1.weight.data.normal_(std = self.stddev)
        self.fc2.weight.data.normal_(std = self.stddev)
