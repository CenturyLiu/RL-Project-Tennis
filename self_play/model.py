...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun  4 18:14:25 2020
...
class ActorParamNoise(Actor):
    def __init__(self, local_obs_dim, action_size, seed = 2, fc1_units = 256, fc2_units = 128, stddev = 0.1):
        Actor.__init__(self,local_obs_dim, action_size, seed = 2, fc1_units = 256, fc2_units = 128)
        self.stddev = stddev
