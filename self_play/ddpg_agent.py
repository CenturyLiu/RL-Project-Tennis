...
TRAIN_EVERY = 2        # every TRAIN_EVERY timesteps, update the network 
DECAY_NOISE = 1e-6         # the noise will decay per episode
N_LEARN_UPDATES = 10
...
class Agent():
    ...
    def __init__(self, state_size, action_size, random_seed, num_agents):
        ...
        # Noise process
        self.noise = OUNoise((num_agents,action_size), random_seed, mu=0., theta=0.15, sigma=0.2)
